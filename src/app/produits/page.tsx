  ...
  const creditCategories = [
    ...
    },
    {
      ...
      products: [
        ...
        // CP, CMP, CA are hidden per instructions
      ]
    },
    {
      title: "Crédit Cause",
    ...
    <>
      <Section variant="primary" className="pt-[160px] pb-16 md:pt-[200px] md:pb-24 relative overflow-hidden">
        ...
        <div className="text-center max-w-3xl mx-auto relative z-10 reveal-up">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Nos Produits & Services</h1>
      ...
      <Section variant="default" id="credit">
        <div className="flex items-center mb-10 reveal-left">
          ...
          <h2 className="text-3xl font-bold text-primary-dark">Nos Offres de Crédit</h2>
        </div>
      ...
      <Section variant="muted" id="autres-services">
        <div className="text-center mb-16 reveal-up">
          <h2 className="text-3xl font-bold text-primary-dark mb-4">Plus que du financement</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-8 reveal-up delay-200">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-outline-variant/30 flex items-start">
              <BookOpen className="h-8 w-8 text-accent mr-4 flex-shrink-0" />
              <div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-outline-variant/30 flex items-start">
              <Lightbulb className="h-8 w-8 text-accent mr-4 flex-shrink-0" />
              <div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-outline-variant/30 flex items-start">
              <Handshake className="h-8 w-8 text-accent mr-4 flex-shrink-0" />
              <div>
