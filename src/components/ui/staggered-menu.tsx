...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    ...
    >
      ...
      <header className={`staggered-menu-header ${isScrolled ? 'is-scrolled' : ''}`} aria-label="Main navigation header">
          ...
          {logoUrl ? (
            <Link href="/" onClick={closeMenu}>
              <img
                src={logoUrl}
                alt="Logo"
                className="sm-logo-img brightness-0 invert"
                draggable={false}
              />
            </Link>
          ) : null}
        ...
        <div className="sm-panel-inner">
            ...
            {items && items.length ? (
              ...
              <li className="sm-panel-itemWrap" aria-hidden="true">
                <span className="sm-panel-item">
                  <span className="sm-panel-itemLabel">Aucun élément</span>
                </span>
              </li>
            )}
          </ul>
          {displaySocials && socialItems && socialItems.length > 0 && (
            <div className="sm-socials" aria-label="Social links">
              <h3 className="sm-socials-title">Nous contacter</h3>
