    ...
    <Section variant="light" className="relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        <div className="space-y-6 reveal-left">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white text-primary text-sm font-bold tracking-wide uppercase shadow-sm">
            <MapPin className="h-4 w-4" />
            Notre Réseau
          </div>
          
          <h2 className="text-3xl md:text-4xl font-bold text-primary-dark">Toujours plus proche de vous</h2>
          
          <p className="text-on-surface-variant text-lg">
            Avec nos 5 points de service stratégiquement répartis, Salem Braha Finance s'assure d'être au plus près de vos activités pour vous offrir un service rapide et de proximité.
          </p>
        ...
        <div className="relative h-[400px] bg-white rounded-2xl shadow-xl overflow-hidden reveal-right border border-outline-variant p-2">
